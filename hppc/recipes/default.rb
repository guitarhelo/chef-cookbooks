...
pcserver_setup_exe      =  extract_path+  "\\Setup\\Install\\Server\\PCServer.msi"
...
pc_server_setup_cmd = "msiexec /i #{pcserver_setup_exe} /qnb"

execute "install Performance Server" do
  command pc_server_setup_cmd
end
