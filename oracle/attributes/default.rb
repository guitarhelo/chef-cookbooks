...
default[:oracle][:user][:pw_set] = true
default[:oracle][:user][:edb] = 'oracle'
default[:oracle][:user][:edb_item] = '1Q2w3e4r5t'
...
#default[:oracle][:rdbms][:install_files] = ['https://https-server.example.localdomain/path/to/p10404530_112030_Linux-x86-64_1of7.zip',                                            'https://https-server.example.localdomain/path/to/p10404530_112030_Linux-x86-64_2of7.zip']
default[:oracle][:rdbms][:install_files] = ['linux.x64_11gR2_database_1of2.zip','linux.x64_11gR2_database_2of2.zip']

   
default[:oracle][:rdbms][:install][:share_url]="10.10.0.2:/srv/software/Oracle/sql_11g"
# Client dependencies
...
default[:oracle][:rdbms][:sys_pw] = '1Q2w3e4r5t'
default[:oracle][:rdbms][:system_pw] = '1Q2w3e4r5t'
default[:oracle][:rdbms][:dbsnmp_pw] = '1Q2w3e4r5t'
...
default[:oracle][:rdbms][:dbconsole][:sysman_pw] = '1Q2w3e4r5t'
